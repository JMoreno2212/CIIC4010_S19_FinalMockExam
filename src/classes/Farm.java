...
public class Farm { // You can probably guess where the inspiration came from (Yes I used to... it was fun okay)
	...
	public Farm(ArrayList<String> crops, ArrayList<String> animals, String[] itemsForSale, int money) {
		this.crops = crops;
